...
1. Import it into your script or notebook: `from config_template import config`
...
config = {
    ...
    "node_params": {
        ...
        "Endo_Linear_Additive": {
            ...
            "noise_model": {
                "name": "additive",
                "dist": "gaussian", # Currently only 'gaussian' is implemented for additive
                "std": 0.5
            }
        },
        "Endo_Poly_Multiplicative": {
            ...
            "noise_model": {
                "name": "multiplicative",
                "std": 0.2 # Multiplies base value by N(1, 0.2)
            }
        },
        "Endo_Interaction_Hetero": {
            "type": "continuous",
